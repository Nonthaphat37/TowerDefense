...
public class MonsterLv2Boss extends Monster {
	...
	public MonsterLv2Boss(float x, float y) throws SlickException {
		super(x, y);
		Monster = new SpriteSheet("res/Monsters/MonsterLv2Boss/MonsterLv2Boss.png", 100, 100);
		MonsterSkill = new SpriteSheet("res/Monsters/MonsterLv2Boss/MonsterLv2BossSkill.png", 100, 100);
	...
	public void render(Graphics g) {
			...
			MonsterAnimation.draw(x-12,y-12,new Color(20,255,200));  //20 255 200
			if(skillShow){
