...
public class MonsterLv3 extends Monster {
	...
	private int hpMonsterthis = 1100;

	public MonsterLv3(float x, float y) throws SlickException {
		super(x, y);
		Monster1 = new SpriteSheet("res/Monsters/MonsterLv3/MonsterLv3_1.png",
				78, 78);
		Monster2 = new SpriteSheet("res/Monsters/MonsterLv3/MonsterLv3_2.png",
				78, 78);
