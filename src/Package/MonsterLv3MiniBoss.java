...
public class MonsterLv3MiniBoss extends Monster {
	...
	public MonsterLv3MiniBoss(float x, float y) throws SlickException {
		super(x, y);
		Monster1 = new SpriteSheet("res/Monsters/MonsterLv3MiniBoss/MonsterLv3MiniBoss_1.png",110,110);
		Monster2 = new SpriteSheet("res/Monsters/MonsterLv3MiniBoss/MonsterLv3MiniBoss_2.png",110,110);
